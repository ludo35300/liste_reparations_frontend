...
import { faGrip, faQrcode, faChartBar, faMagnifyingGlass, faGears, faWrench, faBoxes } from '@fortawesome/free-solid-svg-icons';
...
export class NavService {
  readonly navItems: NavItem[] = [
    ...
    { label: 'Inventaire', route: '/inventaire', icon: faBoxes },
